...
public sealed partial class MainPage : Page
{
    ...
    {
        InitializeComponent();
        ((App)Application.Current).SetTitle((string)Application.Current.Resources["profiler"]);
        ((App)Application.Current).SetClosing(Window_Closing);
        root.Loaded += Window_Loaded; ;
        ctlDevs.navView.SelectionChanged += (NavigationView, NavigationViewSelectionChangedEventArgs) => { tbCalibrate.IsEnabled = ctlDevs.navView.SelectedItem != null; };
    }
