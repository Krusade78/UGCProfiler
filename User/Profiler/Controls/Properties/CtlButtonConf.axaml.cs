...
namespace Profiler.Controls.Properties
{
    internal partial class CtlButtonConf : UserControl
    {
...
#if DEBUG
        public CtlButtonConf() { this.InitializeComponent(); }
#endif
        ...
        private void NumericUpDownPositions_TextChanged(FluentAvalonia.UI.Controls.NumberBox sender, FluentAvalonia.UI.Controls.NumberBoxValueChangedEventArgs args)
        {
            if (parent.Events)
