...
#if DEBUG
        public CtlAxisConf() { this.InitializeComponent(); parent = new(); }
#endif
...
//#endif
        ...
        private void NumericUpDownMSensibility_TextChanged(NumberBox _1, NumberBoxValueChangedEventArgs _2)
        {
            if (parent.Events)
            {
                SetMouseSensibility();
        ...
        private void NumericUpDownResistanceInc_TextChanged(NumberBox _1, NumberBoxValueChangedEventArgs _2)
        {
            if (parent.Events)
            {
                SetResistance(true);
        ...
        private void NumericUpDownResistanceDec_TextChanged(NumberBox _1, NumberBoxValueChangedEventArgs _2)
        {
            if (parent.Events)
            {
                SetResistance(false);
        ...
        private void SetAxisMode()
        {
            ...
            else if (RadioButtonIncremental.IsOn == true)
            {
                axis.Type |= inc;
