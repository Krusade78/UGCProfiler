...
namespace Profiler.Pages.Macros
{
    public sealed partial class CtlVKBGladiatorNXT : UserControl, IChangeMode
    {
        ...
        public CtlVKBGladiatorNXT()
        {
            ...
            changing = true;
            cpColor2.Color = Windows.UI.Color.FromArgb(255, 255, 0, 0);
            cpColor1.Color = Windows.UI.Color.FromArgb(255, 0, 0, 255);
        ...
        private void Color1Picker_ColorChanged(ColorPicker sender, ColorChangedEventArgs args)
        {
            if (!changing)
            {
                txtColor1.Text = (args.NewColor.R * 7 / 255) + ";" + (args.NewColor.G * 7 / 255) + ";" + (args.NewColor.B * 7 / 255);
                Windows.UI.Color c = Windows.UI.Color.FromArgb(255, ColorFromLed(args.NewColor.R), ColorFromLed(args.NewColor.G), ColorFromLed(args.NewColor.B));
                ...
                rColor1.Fill = new Microsoft.UI.Xaml.Media.SolidColorBrush(c);
                changing = true;
                cpColor1.Color = c;
                changing = false;
            }
        ...
        private void Color2Picker_ColorChanged(ColorPicker sender, ColorChangedEventArgs args)
        {
            if (!changing)
            {
                ...
                rColor2.Fill = new Microsoft.UI.Xaml.Media.SolidColorBrush(c);
                changing = true;
                cpColor2.Color = c;
                changing = false;
            }
        ...
        private void FcbLed_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (cbLed.SelectedIndex == 0)
            {
                ...
                rColor1.Fill = new Microsoft.UI.Xaml.Media.SolidColorBrush(Microsoft.UI.Colors.Blue);
                rColor2.Fill = new Microsoft.UI.Xaml.Media.SolidColorBrush(Microsoft.UI.Colors.Red);
            ...
            else if (cbLed.SelectedIndex == 1)
            {
                ...
                changing = true;
                cpColor1.Color = Windows.UI.Color.FromArgb(255, 255, 0, 0);
                cpColor2.Color = Windows.UI.Color.FromArgb(255, 0, 0, 0);
                changing = false;
                sbColor1.IsEnabled = true;
                sbColor2.IsEnabled = false;
                rColor1.Fill = new Microsoft.UI.Xaml.Media.SolidColorBrush(Microsoft.UI.Colors.Red);
                rColor2.Fill = new Microsoft.UI.Xaml.Media.SolidColorBrush(Microsoft.UI.Colors.Black);
            ...
            else
            {
                ...
                txtColor2.Text = "0;0;0";
                changing = true;
                cpColor1.Color = Windows.UI.Color.FromArgb(255, 255, 255, 255);
                cpColor2.Color = Windows.UI.Color.FromArgb(255, 0, 0, 0);
                changing = false;
                sbColor1.IsEnabled = true;
                sbColor2.IsEnabled = true;
                rColor1.Fill = new Microsoft.UI.Xaml.Media.SolidColorBrush(Microsoft.UI.Colors.White);
                rColor2.Fill = new Microsoft.UI.Xaml.Media.SolidColorBrush(Microsoft.UI.Colors.Black);
                //((ComboBoxItem)cbModo.Items[1]).IsEnabled = false;
                //((ComboBoxItem)cbModo.Items[2]).IsEnabled = false;
                //((ComboBoxItem)cbModo.Items[3]).IsEnabled = false;
