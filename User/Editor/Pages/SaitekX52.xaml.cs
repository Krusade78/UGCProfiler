...
namespace Profiler.Pages
{
    ...
    internal sealed partial class SaitekX52 : Page, IHidToButton
    {
        ...
        {
            props.Show(0x6a30255, 9, "Seta 2 Noreste");
        }
        ...
        {
            props.Show(0x6a30255, 11, "Seta 2 Sureste");
        }
        ...
        {
            props.Show(0x6a30255, 13, "Seta 2 Suroeste");
        }
        ...
        {
            props.Show(0x6a30255, 15, "Seta 2 Noroeste");
        }
        #endregion
        ...
        {
            props.Show(0x6a30255, 3, (string)ButtonR.Content);
        }
        #endregion
        #endregion
        ...
        {
            props.Show(0x6a30255, 1, "Seta 3 Noreste");
        }
        ...
        {
            props.Show(0x6a30255, 3, "Seta 3 Sureste");
        }
        ...
        {
            props.Show(0x6a30255, 5, "Seta 3 Suroeste");
        }
        ...
        {
            props.Show(0x6a30255, 7, "Seta 3 Noroeste");
        }
        #endregion
        ...
        {
            props.Show(0x6a30255, 9, "Seta 4 Noreste");
        }
        ...
        {
            props.Show(0x6a30255, 11, "Seta 4 Sureste");
        }
        ...
        {
            props.Show(0x6a30255, 13, "Seta 4 Suroeste");
        }
        ...
        {
            props.Show(0x6a30255, 3, (string)ButtonRx.Content);
        }
        ...
        {
            props.Show(0x6a30255, 2, (string)ButtonZ.Content);
        }
        #endregion
        #endregion
    }
