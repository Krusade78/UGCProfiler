...
namespace Calibrator
{
    ...
    public partial class Info : UserControl
    {
        ...
        private void Timer_Tick(object sender, System.EventArgs e)
        {
            ...
            uint cbsize = 0;
            uint ret = CRawInput.GetRawInputDeviceInfo(hJoy, CRawInput.RawInputDeviceInfoCommand.PreparsedData, IntPtr.Zero, ref cbsize);
            ...
            {
                //cbsize *= 8;
                IntPtr buff = Marshal.AllocHGlobal((int)cbsize);
                ret = CRawInput.GetRawInputDeviceInfo(hJoy, CRawInput.RawInputDeviceInfoCommand.PreparsedData, buff, ref cbsize);
                ...
                if (ret != 0)
                {
                    ...
                    byte[] hidData = new byte[cbsize];
                    Marshal.Copy(buff, hidData, 0, (int)cbsize);
                    ActualizarEstado(hidData);
                        //}
