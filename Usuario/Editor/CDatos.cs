...
namespace Editor
{
    class CDatos : IDisposable
    {
        ...
        public void Nuevo()
        {
            ...
            Perfil.MAPAEJES.FindByidJoyidPinkieidModoidEje(0, 0, 0, 0).TipoEje = 1;
            Perfil.MAPAEJES.FindByidJoyidPinkieidModoidEje(0, 0, 0, 1).TipoEje = 1;
            Perfil.MAPAEJES.FindByidJoyidPinkieidModoidEje(0, 0, 0, 5).TipoEje = 1;
            ...
            Perfil.MAPAEJES.FindByidJoyidPinkieidModoidEje(2, 0, 0, 0).TipoEje = 1;
            Perfil.MAPAEJES.FindByidJoyidPinkieidModoidEje(2, 0, 0, 1).TipoEje = 1;
