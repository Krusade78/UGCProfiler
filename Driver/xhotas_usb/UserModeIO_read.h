...
EVT_WDF_IO_QUEUE_IO_DEVICE_CONTROL EvtIOCtlUsuario;
...
#define IOCTL_USR_CALIBRADO		CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0108, METHOD_BUFFERED, FILE_WRITE_ACCESS)
#define IOCTL_USR_MAPA		CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0109, METHOD_BUFFERED, FILE_WRITE_ACCESS)
#define IOCTL_USR_COMANDOS		CTL_CODE(FILE_DEVICE_UNKNOWN, 0x010a, METHOD_BUFFERED, FILE_WRITE_ACCESS)
#endif
