...
#define IOCTL_GET_MENU		CTL_CODE(FILE_DEVICE_UNKNOWN, 0x080c, METHOD_BUFFERED, FILE_READ_ACCESS)
#define IOCTL_DESACTIVAR_MENU CTL_CODE(FILE_DEVICE_UNKNOWN, 0x080d, METHOD_BUFFERED, FILE_WRITE_ACCESS)
